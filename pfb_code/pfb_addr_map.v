...
module pfb_addr_map #(
    parameter   ADDR_W      = 14,   // 14 bits can store addresses for 16384 pixels
    parameter   BANK_BITS   = 2     // 2 bits can represent 4 banks
) (
    input   wire    [ADDR_W - 1         :0] global_addr,
    output  wire    [BANK_BITS - 1      :0] bank_sel,
    output  wire    [ADDR_W - BANK_BITS :0] local_addr
);
